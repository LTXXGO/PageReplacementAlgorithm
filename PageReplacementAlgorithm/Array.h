...
public:
    ...
    void quickSort() { quickSort(0, size); }//整个数组快速排序
    void quickSort(int low, int high);//对区间[low, high)快速排序
    int partition(int low, int high);//通过调整元素位置构造区间[low, high]的轴点，返回其秩
